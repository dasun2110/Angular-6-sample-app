...
var DetailsComponent = /** @class */ (function () {
    function DetailsComponent(data, route) {
        ...
        this.data = data;
        this.route = route;
        this.route.params.subscribe(function (params) { return _this.users$ = params.id; });
    }
    DetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getUser(this.users$).subscribe(function (data) { return _this.users$ = data; });
    };
...
module.exports = __webpack_require__(/*! C:\Users\Dasun Tharaka\ajs6\ng6\src\main.ts */"./src/main.ts");
